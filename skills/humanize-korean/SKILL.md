...
Use this English `SKILL.md` as the only executable instruction source. `SKILL.ko.md` is a non-authoritative Korean translation kept synchronized with this file for human readers.

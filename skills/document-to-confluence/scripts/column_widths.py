...
Image columns require an explicit ``--floor INDEX=PIXELS`` because cell text does not contain
reliable image dimensions. Impossible floor totals and invalid numeric options fail.

...
> 영어 원본: [korean-writing.md](korean-writing.md)
...
- 마땅한 한국어가 없거나 한국어가 더 낯설면 통용되는 외래어를 쓴다.
  억지로 순화하지 않는다.
- 외래어와 고유어를 모든 문맥에 적용하는 치환 쌍으로 취급하지 않는다. 문맥, 독자, 장르, 프로젝트의 기존 용례,
  자연스러운 어울림을 보고 표현을 고른다. 가능한 고유어가 있더라도 익숙한 외래어가 더 자연스러울 수 있다.
